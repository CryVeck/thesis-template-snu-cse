...
%% 여름졸업이면 8월, 겨울졸업이면 2월
%\graddate{2022~년~2~월}
\graddate{July 2023}{2023~년~07~월}
...
\committeemembersA{Chair}{위~원~장}
\committeemembersB{Vice Chair}{지~도~교~수~님}
\committeemembersC{Examineer}{교~수~님}
\committeemembersD{Examineer}{교~수~님}
\committeemembersE{Examineer}{교~수~님}
%% Length of underline
...
\input{subparts/01-intro.tex}

\input{subparts/02-background.tex}


\chapter{Your paper 01}
\label{chp:paper01}

\input{subparts/03-your-paper-1.tex}


\chapter{Your paper 02}
\label{chp:paper02}

\input{subparts/04-your-paper-2.tex}


\input{subparts/xx-conclusion.tex}
...
\input{subparts/yy-acknowledgements.tex}

\input{subparts/zz-korean-summary.tex}
